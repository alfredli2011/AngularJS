...
.controller('ArticlesCategoryCtrl',['$scope','$http','$routeParams',function($scope,$http,$routeParams){
	$http.get('/articles/category/'+$routeParams.category).then(function(response){
		$scope.articles_category=response.data;
...
.controller('AddArticleCtrl',['$scope','$http','$routeParams','$location',function($scope,$http,$routeParams,$location){
...
.controller('EditArticleCtrl',['$scope','$http','$routeParams','$location',function($scope,$http,$routeParams,$location){
	$http.get('/categories').then(function(response){
		$scope.categories=response.data;
	});
	$http.get('/articles/'+$routeParams.id).then(function(response){
